...
-- ─── Vehicles ──────────────────────────────────────────────────────────────────
-- One client may own many vehicles. Each vehicle has its own insurance package
-- (policy_type, insurer, premium, dates) and its own payment schedule.
...
create index idx_vehicles_policy_type on vehicles(policy_type);
create index idx_vehicles_insurer on vehicles(insurer);
create index idx_vehicles_client_policy on vehicles(client_id, policy_type);
